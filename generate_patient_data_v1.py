...
Generates synthetic patient wearable data for scoring engine validation.
Output schema matches scoring_engine_v1.py expectations.

Usage:
  python3 generate_patient_data_v1.py
  python3 generate_patient_data_v1.py --seed 123
  python3 generate_patient_data_v1.py --output my_data.json
  python3 generate_patient_data_v1.py --seed 42 --output patient_data_v1.json
"""
...
def main():
    parser = argparse.ArgumentParser(description="Patient Wearable Risk Data Generator v1")
    parser.add_argument("--seed",   type=int, default=42,
                        help="Random seed for reproducibility (default: 42)")
    parser.add_argument("--output", default="patient_data_v1.json",
                        help="Output JSON file path (default: patient_data_v1.json)")
    ...
    print(f"\nOutput: {args.output} ({os.path.getsize(args.output)/1024/1024:.1f} MB)")
